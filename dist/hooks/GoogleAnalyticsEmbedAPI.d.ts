...
export interface GoogleAnalyticsEmbedAPI {
    ...
    client: {
        ...
        analytics: {
            ...
            provisioning: {
                createAccountTicket: () => any;
                createAccountTree: () => any;
            };
            userDeletion: {
                userDeletionRequest: {
                    upsert: () => any;
 ...
 */
export declare type Data = GoogleComponent;
/**
 ...
 */
export declare type DataChart = GoogleComponent;
/**
 ...
 */
export declare type ViewSelector = GoogleComponent;
...
export interface Chart {
     ...
     */
    options: LineChartOptions | ColumnChartOptions | BarChartOptions | TableChartOptions | GeoChartOptions | PieChartOptions;
}
/** [`BAR` Chart Configuration Options](https://developers.google.com/chart/interactive/docs/gallery/barchart#configuration-options) */
