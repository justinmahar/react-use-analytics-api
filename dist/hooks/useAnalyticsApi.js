...
if (typeof window !== 'undefined') {
  ...
  if (win.gapi && win.gapi.analytics) {
    ...
    exports.apiSingleton.gapi =
      !!win.gapi.analytics.ViewSelector &&
      !!win.gapi.analytics.auth &&
      !!((_a = win.gapi.analytics) === null || _a === void 0 ? void 0 : _a.googleCharts.DataChart)
        ? win.gapi
        : undefined;
...
exports.useAnalyticsApi = function() {
  const _a = React.useState(exports.apiSingleton.gapi),
    gapi = _a[0],
    setGapi = _a[1];
  const _b = React.useState(typeof exports.apiSingleton.gapi !== 'undefined'),
    hookReady = _b[0],
    setHookReady = _b[1];
  const _c = React.useState(exports.apiSingleton.authorized),
    authorized = _c[0],
    setAuthorized = _c[1];
  const _d = React.useState(undefined),
    error = _d[0],
    setError = _d[1];
  ...
  React.useEffect(
    ...
    [setAuthorized, setError, setGapi, setHookReady]
  );
