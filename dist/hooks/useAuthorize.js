...
exports.useAuthorize = function (gapi, options, onSignIn) {
  var _a = React.useState(useAnalyticsApi_1.apiSingleton.authorized),
    authorized = _a[0],
    setAuthorized = _a[1];
  ...
  React.useEffect(function () {
    ...
    useAnalyticsApi_1.apiStateEmitter.on(
      useAnalyticsApi_1.authorizedEvent,
      authorizedListener
    );
    return function () {
      aborted = true;
      useAnalyticsApi_1.apiStateEmitter.off(
        useAnalyticsApi_1.authorizedEvent,
        authorizedListener
      );
    };
      ...
      if (run) {
        ...
        if (typeof gapi !== "undefined") {
          var signInHandler = function () {
            ...
            useAnalyticsApi_1.apiStateEmitter.emit(
              useAnalyticsApi_1.authorizedEvent,
              true
            );
