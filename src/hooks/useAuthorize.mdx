...
### Using A [Client ID](https://devboldly.github.io/react-analytics-charts/google-oauth-client-id)
...
The following example demonstrates use of the `useAuthorize` hook with a [Client ID](https://devboldly.github.io/react-analytics-charts/google-oauth-client-id) to sign a user into Google Analytics.
